    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 460 }}>
        ...
        <div style={{ background: 'var(--beige)', position: 'relative', overflow: 'hidden' }}>
          ...
          <img src={window.__resources.homeHero} alt="Marijke Koomen in gesprek met twee professionals aan tafel" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center center', display: 'block', position: 'absolute', inset: 0 }} />
        </div>
      </div>
      <SectionDivider />
      ...
      <div style={{ padding: '56px 48px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          <Card accent="bordeaux">
            <div style={{ fontFamily: 'Lora, serif', fontSize: 15, fontWeight: 500, color: 'var(--fg1)', marginBottom: 10, lineHeight: 1.45 }}>Je casus klopt niet, maar je kunt het niet benoemen</div>
            <div style={{ fontSize: 13, color: 'var(--fg2)', lineHeight: 1.6 }}>Je hebt een knoop in je maag na elk gesprek met die ene ouder. Je schrijft het op, maar het klinkt niet overtuigend. Dat is precies waar ik begin.</div>
          </Card>
          <Card accent="olive">
          ...
          <Card accent="amber">
            <div style={{ fontFamily: 'Lora, serif', fontSize: 15, fontWeight: 500, color: 'var(--fg1)', marginBottom: 10, lineHeight: 1.45 }}>Je ziet twee ouders. Maar de dynamiek is niet gelijkwaardig.</div>
            <div style={{ fontSize: 13, color: 'var(--fg2)', lineHeight: 1.6 }}>Bij intiem terreur is er altijd sprake van een machtsdisbalans. Het past niet op een afvinklijstje. Maar het is wel zichtbaar, als je weet waar je op let.</div>
          </Card>
        </div>
      </div>
